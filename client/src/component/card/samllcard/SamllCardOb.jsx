...
import Verification from "../../../Hotels/Hotel/Verification";

const SamllCardOb = ({
  h,
  owner = false,
  viewMoreButton = true,
  handelHotelDelete = (f) => f,
}) => {
            ...
            <div className="content">
              ...
              <p className="location">
                ...
                <b>
                  {" "}
                  {allDays(h.from, h.to)}{" "}
                  {allDays(h.from, h.to) <= 1 ? " day" : " days"}
                </b>
              </p>
              ...
              <div className="price">
                ...
                <span>added: {moment(h.createdAt).fromNow()}</span>
              </div>

              <div className="r-buttons">
                {viewMoreButton && (
                  <a
                    className="btn r-more"
              ...
              {owner && (
                <div className="d-flex justify-content-between h1">
                  ...
                  <MdDelete
                    onClick={() => handelHotelDelete(h._id)}
